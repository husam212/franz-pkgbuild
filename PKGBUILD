...
source_i686=('https://storage.googleapis.com/meetfranzdownloads/downloads/'$pkgver'/Franz-linux-ia32-'$pkgver'.tgz')
source_x86_64=('https://storage.googleapis.com/meetfranzdownloads/downloads/'$pkgver'/Franz-linux-x64-'$pkgver'.tgz')
#Checksums
